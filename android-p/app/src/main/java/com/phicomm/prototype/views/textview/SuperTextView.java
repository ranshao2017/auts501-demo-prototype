...
package com.phicomm.prototype.views.textview;
...
public class SuperTextView extends TextView {
    ...
    public SuperTextView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        init(attrs);
        setAdjuster(new RippleAdjuster(getResources().getColor(R.color.blue)));
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (adjuster != null && adjuster.onTouch(this, event) && isAutoAdjust()) {
