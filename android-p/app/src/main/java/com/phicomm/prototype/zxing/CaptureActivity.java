...
import com.phicomm.prototype.activity.BaseActivity;
...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback, ZxingInterface {
    ...
    public void afterInitView() {
        setPageTitle(getString(R.string.zxing_title));
...
//    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        if (hasFocus) {
            if (cameraManager == null) {
                cameraManager = new CameraManager(MyApplication.getContext(), viewfinderView);
            }
    ...
    protected void onResume() {
        super.onResume();
//        requestRuntimePermission(new String[]{Manifest.permission.CAMERA}, 1001);
